            ...
            <div className="philosophy-hero">
              ...
              <div className="philosophy-hero-content">
                <div className="philosophy-badge">
                  <Sparkles size={14} />
                  <span>مانیفست خانه عطر آنتی • پاریس و تهران</span>
                </div>
                <h2 className="philosophy-title font-brand-story">
                  فلسفه برند آنتی؛ کیمیاگری جاودانگی و شکوه
                </h2>
                <p className="philosophy-lead">
                  در آنتی، ما معتقدیم که عطر، نامرئی‌ترین لباس و عمیق‌ترین بازتاب از اصالت درون است؛ ردپایی از نور که پس از گذشتن شما، جاودانه باقی می‌ماند.
                </p>
              </div>
            </div>
            ...
            <div className="philosophy-section">
              ...
              <div className="pillars-grid">
                ...
                <div className="pillar-card">
                  ...
                  <h4 className="pillar-title">خلوص اسانس و غلظت شاهوار</h4>
                  <p className="pillar-desc">
                    کلیه آثار آنتی با بالاترین استاندارد جهانی <strong>اکستریت د پرفوم (Extrait de Parfum)</strong> و غلظت اسانس روغنی بیش از ۳۰٪ فرموله می‌شوند؛ تضمین ماندگاری بالای ۴۸ ساعت و پراکندگی مسحورکننده در هر فضا.
                  </p>
                </div>
                ...
                <div className="pillar-card">
                  ...
                  <h4 className="pillar-title">تراش کریستال و شاهکار شیشه‌گری</h4>
                  <p className="pillar-desc">
                    هر بطری عطر آنتی به سان یک جواهر دست‌تراش از کریستال فشرده و درپوش‌های سنگین با روکش طلای رزگلد ساخته می‌شود؛ اثری که روی میز آرایش شما مانند تندیسی فاخر می‌درخشد.
                  </p>
                </div>
                ...
                <div className="pillar-card">
                  ...
                  <h4 className="pillar-title">تعهد اخلاقی و پایدار (Cruelty-Free)</h4>
                  <p className="pillar-desc">
                    ۱۰۰٪ محصولات آنتی بدون هیچ‌گونه آزمایش روی حیوانات، با استفاده از الکل ارگانیک گندم و بسته‌بندی‌های بدون پلاستیک و تجزیه‌پذیر از کاغذهای بازیافتی با نشان FSC تولید می‌شوند.
                  </p>
                </div>
                ...
                <div className="pillar-card">
                  ...
                  <h4 className="pillar-title">اصالت شناسنامه‌دار و بچ‌کد حک‌شده</h4>
                  <p className="pillar-desc">
                    هر بطری دارای شناسنامه خلوص بین‌المللی با کد رهگیری اختصاصی لیزری است تا اطمینان خاطر کامل از دریافت قطره‌قطره عصاره اورجینال و بی‌همتا را به شما پیشکش کند.
                  </p>
                </div>
              </div>
            </div>
